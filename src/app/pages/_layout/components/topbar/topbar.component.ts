...
export class TopbarComponent implements OnInit, AfterViewInit {
  ...
  constructor(private service:SharedService,private layout: LayoutService, private auth: AuthService, private route:Router) {
  ...
  ngOnInit(): void {
    ...
    {
        this.service.getEmployeeDetails(localStorage.getItem('emp')).subscribe(data=>{
